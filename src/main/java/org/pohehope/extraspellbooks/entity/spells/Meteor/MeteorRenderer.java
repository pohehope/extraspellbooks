...
public class MeteorRenderer extends EntityRenderer<Meteor> {
    public static final ResourceLocation[] TEXTURES = {
            Extraspellbooks.id("textures/entity/meteor/dust_star.png")
    };
    ...
    @Override
    public void render(Meteor entity, float yaw, float particleTick, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
        ...
        poseStack.popPose();
        super.render(entity, yaw, particleTick, poseStack, bufferSource, light);
    }
